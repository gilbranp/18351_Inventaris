					...
					<div class="p-4 m-3">
						...
						<form method="POST" action="/login" class="needs-validation" novalidate="">
							...
							<div class="form-group">
                                ...
                                <input id="username" type="text" minlength="4" class="form-control @error('username') is-invalid @enderror" name="username" tabindex="1" placeholder="Masukkan username.." value="{{ old('username') }}" required autofocus>
							...
							<div class="form-group">
								...
								<input id="password" type="password" class="form-control @error('password') @enderror" name="password"
									tabindex="2" placeholder="Masukan kata sandi.." required minlength="5" >
								<div class="invalid-feedback">
					...
					<div class="absolute-bottom-left index-2">
						<div class="text-light p-5 pb-2">
							<div class="mb-5 pb-3">
							 ...
							 by <a class="text-light bb" target="_blank" href="https://instagram.com/gilbran_id">Radenta
								Gilbran</a> on <a class="text-light bb" target="_blank" href="https://www.youtube.com/channel/UCiuQuCm-l3VexyQnigBGoTw">EZ</a>
						</div>
					</div>
				</div>
			</div>
